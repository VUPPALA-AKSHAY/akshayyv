  ...
  const experiences: ExperienceItem[] = [
    {
      ...
      position: "Intern — AI / RAG (Remote)",
      duration: "Oct 2024 – Jan 2025",
      description: "Online internship (Springboard 5.0) with hands-on work in advanced AI technologies including RAG.",
      achievements: [
        "Built “Chat with Your Documents” — an AI chatbot that interacts with documents and retrieves insights from various formats.",
        "Strengthened practical knowledge of RAG, NLP concepts and API integration.",
        "Gained professional skills working with advanced AI tooling and document pipelines.",
      ],
    },
    {
      ...
      description: "Designing and shipping AI-powered web products end to end.",
      achievements: [
        "Built HireLens (hirelenss.in) — Gemini-powered LinkedIn vs job-role analyzer with Supabase auth.",
        "Built Hermes outreach agent — multi-country company search, scraper-driven emails and HR follow-ups.",
        "Built KL University chatbot and AI Code Debugger (Igbara.AI hackathon finalist).",
      ],
    },
  ]
