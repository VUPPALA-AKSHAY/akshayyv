...
export const ProjectCard = ({ project, isDetailed = false, allProjects = [] }: ProjectCardProps) => {
  ...
  if (!isDetailed) {
    return (
      ...
      >
        <div className="py-2 text-base sm:text-lg md:text-xl pb-4 sm:pb-5 border-b border-neutral-600 dark:border-neutral-500 transition-all duration-300 group-hover:border-[var(--brand)] dark:group-hover:border-[var(--brand)] group-hover:pl-2">
          <span className="inline-block transition-all duration-300 group-hover:translate-x-1 group-hover:text-[var(--brand)] dark:group-hover:text-[var(--brand)]">
            {project.title}
          </span>
        </div>
      </Link>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Link
                    ...
                    target="_blank"
                    className="bg-neutral-200 border-2 border-black dark:bg-neutral-800 dark:border-neutral-500 p-1.5 rounded-full hover:opacity-70 hover:border-[var(--brand)] touch-manipulation active:opacity-75"
                    style={{
                      WebkitTapHighlightColor: 'transparent',
                      WebkitTouchCallout: 'none',
                      WebkitUserSelect: 'none',
